...
namespace Bakery
{
  public class Program
  {
    public static void Main()
    {
      ...
      {
        case "B":
          Console.WriteLine("It's $5 per loaf, Buy 2 get 1 Free Special! How many loaves would you like?");
        ...
        case "P":
          Console.WriteLine("It's $2 per pastry, or 3 for $5! How many pastries would you like?");
